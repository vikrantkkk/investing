  ...
  return (
    <>
      ...
      {/* <div
        ...
        } h-[100vh] w-screen bg-darkBackGround p-10 relative`}
      >
        <div className="relative flex justify-center w-full items-center bg-[#FFFFFF17]/[0.09] rounded-md p-10">
          <div className="flex-1  flex flex-col md:gap-8 gap-2  justify-center md:items-start items-center ">
            <div className="font-poppins p-2 font-normal text-figmaGreen rounded-[8px] w-auto px-4 bg-greenbackgrond">
              <span className="font-semibold text-[16px] leading-6">
                100000+
              </span>{" "}
            ...
            <div className="font-poppins md:block hidden md:text-[48px] text-[29px] md:leading-[70px] leading-10 font-bold">
              Crack the Code to Trade
              <br /> in the{" "}
              <span className="text-figmaGreen">Stock Market</span> With
              <br /> a Proven System
            </div>
            <div className="font-poppins text-center md:hidden block md:text-[48px] text-[29px] md:leading-[70px] leading-10 font-bold">
              Crack the Code to Trade
          ...
          <div className="w-[50%]  flex  justify-center items-center">
            <div className="absolute  z-10  bottom-72 right-10">
              <img src={circleLogo} alt="CEO" className="w-[70%]" />
            </div>
            <div className="absolute bottom-0 z-10">
        ...
        <div className="absolute top-0 right-0 left-0 h-full z-0 bg-gradient-to-br from-figmaGreen via-transparent to-transparent opacity-50"></div>

      </div> */}
      <div
        className={`${
          darkMode ? "block" : "hidden"
        } h-auto w-screen bg-darkBackGround p-20 relative flex items-center justify-center`}
      >
        {/* Gradient background */}
        ...
        <div className="relative flex justify-center w-full items-center overflow-hidden bg-[#FFFFFF17]/[0.09] rounded-3xl p-10">
          <div className="flex-1 flex flex-col md:gap-8 gap-2 justify-center md:items-start items-center pl-20">
            <div className="font-poppins p-2 font-normal text-figmaGreen rounded-[8px] w-auto px-4 bg-greenbackgrond">
              <span className="font-semibold text-[16px] leading-6">
                100000+
              </span>{" "}
          ...
          <div className="w-[50%] flex justify-center items-center">
            <div className="absolute z-10 bottom-72 right-10">
              <img src={circleLogo} alt="CEO" className="w-[70%] opacity-30" />
            </div>
            <div className="absolute bottom-0 z-10">
              <img src={ceo} alt="CEO" className="h-[70vh]" />
            </div>
            <div className="absolute top-32 right-[42rem]  z-10">
              <img
                src={hero1}
                alt="MyBrand Logo"
            ...
            <div className="absolute top-20 right-[18rem]  z-10">
              <img
                src={hero2}
                alt="MyBrand Logo"
            ...
            <div className="absolute top-60 right-[18rem]  z-10">
              <img
                src={hero3}
                alt="MyBrand Logo"
