...
const cardData = [
  ...
  {
    icon: "https://via.placeholder.com/250x150",
    name: "Prashi",
    designation: "INFOSYS",
  ...
  {
    icon: "https://via.placeholder.com/200x250",
    name: "Chelsi",
  ...
  {
    icon: "https://via.placeholder.com/300x220",
    name: "Madhav",
    designation: "LAWYER",
    text1:
...
const Testimonials = () => {
  return (
    <div className="container flex border-b-2 gap-4 h-[150vh] bg-[#F1F1F1]">
        ...
        <div className="grid grid-cols-2">
          {cardData.map((item) => (
            <div
              ...
              className="bg-white p-6 rounded-2xl shadow-md flex flex-col items-center transition-all duration-300 ease-in-out hover:shadow-[rgba(0,_0,_0,_0.09)_0px_2px_1px,_rgba(0,_0,_0,_0.09)_0px_4px_2px,_rgba(0,_0,_0,_0.09)_0px_8px_4px,_rgba(0,_0,_0,_0.09)_0px_16px_8px,_rgba(0,_0,_0,_0.09)_0px_32px_16px]"
            >
